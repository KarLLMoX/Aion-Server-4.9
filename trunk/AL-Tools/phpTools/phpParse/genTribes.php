...
<div id="body" style='width:800px;padding:0px;'>
  ...
  <div class="hinweis" id="hinw">
    Erzeugen der Tribe-Dateien.<br><br>
    ( tribe_relations.xml und TribeClass.java )
  </div>
  <div width=100%>
...
function generTribeFile()
{
    ...
    logHead("Generierung der Datei: tribe_relations.xml");
    ...
    while (!feof($hdlsvn))
    {
        ...
        switch ($inenum)
        {
            ...
            case 4: // neue Liste hier einfügen
                    fwrite($hdlout,"    /* <!-- new tribe enumeration (sorted by name) --> */\n");
                    fwrite($hdlout,"    /* ".trim(getCopyrightLine())." */\n");
                    $cntout += 2;
